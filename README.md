# barebones-bazel: Master Bazel for Go microservices with this step-by-step guide.
...
Navigate to each directory and use the following Bazel commands:

**Build:**

```bash
bazel build //[directory]:main
```

**Run:**

```bash
bazel run //[directory]:main
```
